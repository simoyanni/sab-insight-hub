...
const fundingGrowthData = [
  { year: "2020", Solar: 120, Wind: 80, Heat: 45, Storage: 20, Hydrogen: 5, Grid: 60, Mobility: 30, Industry: 40 },
  { year: "2021", Solar: 180, Wind: 95, Heat: 65, Storage: 35, Hydrogen: 15, Grid: 75, Mobility: 55, Industry: 52 },
  { year: "2022", Solar: 280, Wind: 120, Heat: 95, Storage: 60, Hydrogen: 35, Grid: 95, Mobility: 85, Industry: 68 },
  { year: "2023", Solar: 420, Wind: 150, Heat: 140, Storage: 95, Hydrogen: 65, Grid: 120, Mobility: 130, Industry: 88 },
  { year: "2024", Solar: 580, Wind: 190, Heat: 195, Storage: 140, Hydrogen: 110, Grid: 155, Mobility: 185, Industry: 115 },
  { year: "2025", Solar: 720, Wind: 240, Heat: 260, Storage: 200, Hydrogen: 180, Grid: 200, Mobility: 250, Industry: 145 },
];
...
const categoryData = [
  { 
    ...
    metrics: [
      { label: "Installed Capacity", value: "5,100 MW" },
      { label: "Potential", value: "9,300 MW" },
      { label: "Gap", value: "4,200 MW" },
    ],
  ...
  { 
    ...
    metrics: [
      { label: "Installed Capacity", value: "2,100 MW" },
      { label: "Potential", value: "4,800 MW" },
      { label: "Gap", value: "2,700 MW" },
    ],
  ...
  { 
    ...
    colorClass: "text-chart-amber",
    metrics: [
      { label: "Heat Pumps", value: "65,000" },
      { label: "Target 2030", value: "180,000" },
      { label: "Gap", value: "115,000" },
    ],
  ...
  { 
    ...
    metrics: [
      { label: "Capacity", value: "1,260 MWh" },
      { label: "Potential", value: "3,500 MWh" },
      { label: "Gap", value: "2,240 MWh" },
    ],
  ...
  { 
    ...
    colorClass: "text-accent",
    metrics: [
      { label: "Capacity", value: "8,500 MW" },
      { label: "Availability", value: "99.7%" },
      { label: "Investment", value: "€850M" },
    ],
  ...
  { 
    ...
    metrics: [
      { label: "EVs Registered", value: "48,500" },
      { label: "Public Chargers", value: "3,480" },
      { label: "Market Share", value: "18.5%" },
    ],
  ...
  { 
    ...
    metrics: [
      { label: "Energy Intensity", value: "-12%" },
      { label: "Renewable Use", value: "34%" },
  ...
  return (
    <DashboardLayout>
      <div className="max-w-7xl mx-auto space-y-10">
        ...
        {/* Main Growth Chart */}
        <div className="bg-card rounded-2xl p-6 card-shadow animate-slide-up" style={{ animationDelay: "100ms" }}>
        ...
        {/* Feature Summary */}
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 animate-slide-up" style={{ animationDelay: "700ms" }}>
